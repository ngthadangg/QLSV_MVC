...
<body>
    ...
    <?php
        ...
        <tr> 
            ...
            <th style='border: 1px solid black; padding: 10px;'>Cập nhật Sinh viên </th> 
        </tr>";
        foreach ($studentList as $i => $student)
        {
            if (isset($studentList[$i])){
                ...
                <td style='border: 1px solid black; padding: 10px;'><a href='../Controller/C_Student.php?action=update&stid=".$student->id."'>XXX</a></td>
            </tr>";
            }
